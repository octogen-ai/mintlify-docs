...
description: "Search, find similar products, and look up products across active crawled catalogs using the Octogen REST API, Python SDK, TypeScript SDK, or MCP integration for AI agents."
---
...
<Steps>
  <Step title="Get access">
    Contact Octogen to provision your organization as a Catalog Partner.
  </Step>
...
<Note>
  Both the REST API and MCP server enforce the same policy: Catalog Partners can search and browse active crawled catalogs, never merchant catalogs. BigQuery listing access remains explicit.
</Note>
