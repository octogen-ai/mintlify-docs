---
title: "What is Octogen? AI commerce for Catalog Partners"
description: "Octogen gives Catalog Partners programmatic access to curated product catalogs — search products, find similar items, look up products by URL, and power AI agent integrations."
---
...
- **Build AI agent workflows** — connect Claude Code, Codex CLI, or Claude Desktop directly to active crawled catalogs via the Catalog Partner MCP server.
...
<CardGroup cols={2}>
  ...
  <Card title="MCP Integration" icon="robot" href="/mcp/overview">
    Connect AI agents to active crawled catalogs via the Catalog Partner MCP server.
  </Card>
