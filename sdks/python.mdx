...
It also installs the `octogen-bq-subscribe` CLI (dry-run by default; `--apply` to subscribe):
...
| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `listing_resource` | `str` | — | Listing resource name from the Platform UI BigQuery sharing page. |
