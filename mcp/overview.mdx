...
- Your organization is provisioned as a Catalog Partner. If you do not yet have a Catalog Partner organization, contact Octogen support.
...
Both surfaces are equally supported and enforce the same catalog policy. Catalog Partners can search and browse active crawled catalogs and cannot access merchant catalogs. BigQuery listings remain explicitly granted.
