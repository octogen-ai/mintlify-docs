...
description: "Register the Octogen MCP server in Claude Code with one command, then let your agent search and look up products from active crawled catalogs."
