...
description: "Searches products across all granted catalogs, or within one catalog when scoped, using free-text queries, structured facet filters, price ranges, and cursor-based pagination."
