...
Subscription applies to catalog listings and to
[coverage URL list](/guides/coverage-url-lists) listings alike — the only
difference is that coverage listings grant your registered Readers access
automatically. BigQuery subscription is a two-party flow:
