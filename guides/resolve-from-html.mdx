...
The `url` field is optional — HTML can still resolve even when you don't know which page it came from. Since your client has `location.href` at capture time, we recommend sending it on every request. It does three jobs:
