...
Refresh starts an asynchronous Octogen workflow. The API returns after the request is accepted, and product data becomes visible after refresh processing and indexing complete.
