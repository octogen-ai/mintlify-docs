...
description: "Use cursor-based pagination to iterate through all matching products in an Octogen search, page by page, without missing or duplicating results."
