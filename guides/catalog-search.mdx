...
description: "Learn how to search products across active crawled catalogs, filter by facets like color and category, and apply price ranges using the Octogen Catalog API."
