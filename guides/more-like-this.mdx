...
For five worked recommendation strategies — same-look, attribute matching, broad discovery, attribute-retrieval ranked by style, and price-bounded similarity — with real requests and live results, see the [strategy recipes guide](/guides/mlt-strategy-recipes).
