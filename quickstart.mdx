...
description: "Go from zero to your first product search result: set up your API key, search active crawled catalogs, and look up a product by URL."
---

This guide walks you through making your first calls to the Octogen Platform Catalog API. By the end, you will have searched products and resolved a product page URL to a full product record — using curl, the Python SDK, or the TypeScript SDK.

## Prerequisites

Before you start, make sure you have:

- A **Developer organization** provisioned by Octogen
- A **Platform API key** from Octogen Platform (see [Authentication](/authentication))
...
- **Connect an AI agent** — use the Developer MCP server to give Claude or Codex direct catalog access. See [MCP overview](/mcp/overview).
